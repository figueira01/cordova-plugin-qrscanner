...
class QRScanner : CDVPlugin, AVCaptureMetadataOutputObjectsDelegate {
    ...
    @objc func prepScanner(command: CDVInvokedUrlCommand) -> Bool{
        ...
        do {
            if (captureSession?.isRunning != true){
                ...
                metaOutput!.metadataObjectTypes = [AVMetadataObject.ObjectType.qr, AVMetadataObject.ObjectType.ean13, AVMetadataObject.ObjectType.code128, AVMetadataObject.ObjectType.code39, AVMetadataObject.ObjectType.aztec, AVMetadataObject.ObjectType.code39Mod43, AVMetadataObject.ObjectType.code93, AVMetadataObject.ObjectType.dataMatrix, AVMetadataObject.ObjectType.ean8, AVMetadataObject.ObjectType.interleaved2of5, AVMetadataObject.ObjectType.itf14, AVMetadataObject.ObjectType.pdf417, AVMetadataObject.ObjectType.upce]
    ...
    func metadataOutput(_ captureOutput: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if ((found.type == AVMetadataObject.ObjectType.qr || found.type == AVMetadataObject.ObjectType.ean13 || found.type == AVMetadataObject.ObjectType.code128 || found.type == AVMetadataObject.ObjectType.code39 || found.type == AVMetadataObject.ObjectType.aztec || found.type == AVMetadataObject.ObjectType.code39Mod43 || found.type == AVMetadataObject.ObjectType.code93 || found.type == AVMetadataObject.ObjectType.dataMatrix || found.type == AVMetadataObject.ObjectType.ean8 || found.type == AVMetadataObject.ObjectType.interleaved2of5 || found.type == AVMetadataObject.ObjectType.itf14 || found.type == AVMetadataObject.ObjectType.pdf417 || found.type == AVMetadataObject.ObjectType.upce) && found.stringValue != nil) {
            scanning = false
